...
<head>
  ...
  <title>String Hoppers - CIBO</title>
  <style>
    .recipe-details {
      margin: 50px auto;
      max-width: 800px;
  ...
  <main>
    <div class="container" style="margin-top: 150px; margin-bottom: 100px;">
      <div class="recipe-details">
        <h2>String Hoppers</h2>
        <img src="img/18.jpg" alt="String Hoppers">
        <p><strong>Description:</strong> String Hoppers are a traditional Sri Lankan dish made from steamed rice flour and coconut, often served with curry or sambol.</p>
        <h3>Ingredients:</h3>
        <ul>
          ...
          <li>String hopper molds (or idiyappam maker)</li>
          <li>Fresh cilantro for garnish (optional)</li>
        </ul>
        <h3>Instructions:</h3>
        <ol>
          <li>In a large bowl, mix the rice flour and salt. Gradually add water, a little at a time, until the mixture is smooth and slightly sticky.</li>
          <li>Grease the string hopper molds or idiyappam maker with a little oil.</li>
          <li>Place a portion of the rice flour mixture into the mold and press out the mixture in a circular motion onto a string hopper maker or into a small steaming tray lined with a clean cloth.</li>
          <li>Steam the string hoppers for about 10-15 minutes, or until cooked through. If using a steaming tray, you can stack the layers of string hoppers on top of each other.</li>
